...
-- CHECK制約を更新して session_snapshot + 既存の ai_deep_analysis を追加
...
ALTER TABLE public.cast_knowledge ADD CONSTRAINT cast_knowledge_report_type_check
  CHECK (report_type IN ('post_session', 'daily_briefing', 'weekly_review', 'session_report', 'session_snapshot', 'marketer_persona_source', 'ai_deep_analysis'));
