...
// ============================================================
// PATCH /api/cast-sticky-notes/[id]
// ============================================================
export async function PATCH(
  ...
  const { account_id, title, content_rich, category, sort_order } = body;
  ...
  try {
    ...
    if (content_rich !== undefined) patch.content_rich = content_rich ?? {};
    ...
    await reportError(e, { file: 'api/cast-sticky-notes/[id]', context: 'PATCH' });
    return NextResponse.json({ error: err.message || '更新エラー' }, { status: 500 });
  }
}

// ============================================================
// DELETE /api/cast-sticky-notes/[id]
// ============================================================
export async function DELETE(
  ...
  try {
    ...
    const err = e as { message?: string };
    await reportError(e, { file: 'api/cast-sticky-notes/[id]', context: 'DELETE' });
